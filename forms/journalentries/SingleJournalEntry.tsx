        ...
        <form id="single-entry-form" onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 border-b border-slate-100 pb-2">
              ...
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Financial Recognition</h3>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-1">
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1">Currency</label>
                <select
                  name="currency"
                  value={formik.values.currency}
                  onChange={formik.handleChange}
                  className="w-full h-9 bg-slate-50/70 border border-slate-200 rounded-lg px-3 text-xs sm:text-sm font-medium focus:outline-none focus:ring-1 focus:ring-slate-900 focus:bg-white focus:border-slate-400 transition-all appearance-none"
                >
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 ml-1">Debit (KES)</label>
                <input
                  type="number"
                  name="debit"
                  placeholder="0.00"
                  ...
                  className="w-full h-9 bg-emerald-50/30 border border-emerald-200 rounded-lg px-3 text-xs sm:text-sm font-mono font-bold text-emerald-700 focus:outline-none focus:ring-1 focus:ring-emerald-600 transition-all placeholder:text-emerald-300"
                />
              </div>
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-rose-600 ml-1">Credit (KES)</label>
                <input
                  type="number"
                  name="credit"
                  placeholder="0.00"
                  ...
                  className="w-full h-9 bg-rose-50/30 border border-rose-200 rounded-lg px-3 text-xs sm:text-sm font-mono font-bold text-rose-700 focus:outline-none focus:ring-1 focus:ring-rose-600 transition-all placeholder:text-rose-300"
                />
              </div>
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1 truncate">Exchange Rate</label>
                <input
                  type="number"
                  name="exchange_rate"
                  step="0.0001"
                  ...
                  onChange={formik.handleChange}
                  className="w-full h-9 bg-slate-50/70 border border-slate-200 rounded-lg px-3 text-xs sm:text-sm font-medium focus:outline-none focus:ring-1 focus:ring-slate-900 transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 border-b border-slate-100 pb-2">
              ...
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Evidence &amp; Notes</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1">Evidence Type</label>
                <select
                  name="source_document"
                  value={formik.values.source_document}
                  onChange={formik.handleChange}
                  className="w-full h-9 bg-slate-50/70 border border-slate-200 rounded-lg px-3 text-xs sm:text-sm font-medium focus:outline-none focus:ring-1 focus:ring-slate-900 transition-all outline-none"
                >
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  onChange={formik.handleChange}
                  className="w-full h-9 bg-slate-50/70 border border-slate-200 rounded-lg px-3 text-xs sm:text-sm font-medium transition-all outline-none"
                >
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1">Document #</label>
                <input
                  name="document_number"
                  placeholder="REF-001"
                  value={formik.values.document_number}
                  onChange={formik.handleChange}
                  className="w-full h-9 bg-slate-50/70 border border-slate-200 rounded-lg px-3 text-xs sm:text-sm font-mono font-medium outline-none"
                />
              </div>
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 ml-1">Attach Proof</label>
                <div className="relative">
                  ...
                  <label
                    ...
                    className="flex h-9 bg-slate-50/70 border border-dashed border-slate-300 rounded-lg items-center px-3 gap-2 text-slate-500 hover:border-slate-400 hover:bg-slate-100 transition-all cursor-pointer group"
                  >
            ...
            <textarea
              ...
              onChange={formik.handleChange}
              className="w-full bg-slate-50/70 border border-slate-200 rounded-lg p-3 text-xs sm:text-sm font-medium outline-none focus:ring-1 focus:ring-slate-900 focus:bg-white focus:border-slate-400 transition-all resize-none"
            />
          </div>
        </form>
      </div>

      <div className="px-5 py-3 sm:py-3.5 border-t border-slate-100 bg-slate-50/50">
        <button
          type="submit"
          form="single-entry-form"
          disabled={formik.isSubmitting}
          className="w-full h-9 sm:h-10 bg-slate-900 text-white rounded-lg font-bold text-xs uppercase tracking-wider shadow-sm active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        >
