...
import { createOperations } from "@/services/accounts";
...
export default function CreateOperations({ trigger }: CreateOperationsProps) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        ...
        toast.success("Operations member established successfully");
        ...
        const errorMessage =
          ...
          "Failed to establish operations member";
