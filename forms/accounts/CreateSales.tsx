  ...
  return (
    <>
      <div onClick={() => setOpen(true)} className="cursor-pointer">
        {trigger || (
          <button className="h-14 px-8 bg-slate-900 hover:bg-emerald-600 text-white rounded font-semibold text-sm tracking-tight transition-all shadow-xl hover:shadow-emerald-600/20 active:scale-[0.98] flex items-center gap-3 group">
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full h-14 rounded border border-slate-200 bg-slate-50 focus:bg-slate-50 focus:border-emerald-600/30 focus:ring-0 transition-all font-semibold px-6 text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full h-16 bg-slate-900 hover:bg-emerald-600 text-white rounded font-semibold text-base transition-all shadow-xl hover:shadow-emerald-600/20 active:scale-[0.98] group relative overflow-hidden flex items-center justify-center"
                  >
                    {formik.isSubmitting ? (
