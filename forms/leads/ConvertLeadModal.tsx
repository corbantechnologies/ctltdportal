    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded shadow-2xl z-[101] overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
          <div className="p-4 sm:p-5 border-b border-slate-100 bg-slate-50/50 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Dialog.Title className="text-base font-bold text-slate-900 tracking-tight">Convert to Partner</Dialog.Title>
                  <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Transforming prospect: <span className="text-blue-600">{leadName}</span></p>
                </div>
              </div>
          ...
          <div className="p-4 sm:p-5 space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between px-1">
                <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Classify Partnership Type</p>
                ...
                {partnerTypes?.map((type) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center justify-between p-3 rounded border transition-all group relative overflow-hidden",
                        isSelected
                    ...
                    >
                      <div className="flex items-center gap-3 relative z-10">
                        ...
                        <div className="text-left">
                          <p className="text-xs font-bold uppercase tracking-tight">{type.name}</p>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full h-9 sm:h-10 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold text-xs sm:text-sm tracking-tight transition-all shadow-sm shadow-blue-600/20 disabled:opacity-50 disabled:shadow-none active:scale-95 flex items-center justify-center gap-2"
              >
              ...
              <div className="bg-slate-50 p-2.5 rounded flex items-start gap-2">
