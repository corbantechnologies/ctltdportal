...
const SIMULATION_SCENARIOS: SimulationScenario[] = [
  ...
  {
    title: "Unified Full-Page Journal Batch Studio (Balanced Double-Entry)",
    category: "General Ledger Workbench",
    description: "Enter journal batch header and interactive balanced debit/credit lines on one unified screen with live reconciliation.",
    type: "JOURNAL",
    debit: {
      account: "Operating / Asset Schedule Book",
      code: "6020-EXP",
      type: "Expense / Asset (Debit Increases Balance)",
      note: "Recognizes expense or adds capital asset in active financial period",
    },
    credit: {
      account: "Balancing Credit Book (e.g. Bank / Payable / Accrual)",
      code: "1010-BNK",
      type: "Asset / Liability (Credit Decreases Asset or Increases Liability)",
      note: "Live reconciliation ensures Total Debits === Total Credits before posting",
    },
    portalAction: "Open Journal Studio > Fill Header & Add Balanced Lines > Click 'Save & Post to GL'",
    portalLink: "/finance/journal-entries/studio",
    exampleData: {
      amount: "KES 150,000.00 (Balanced)",
      partner: "Standard Ledger Schedule",
      division: "Corporate Operations",
      ledgerBook: "[6020] Office Rent & Facilities",
      paymentMethod: "Bank Transfer",
    },
  },
  {
    title: "Bulk Journal Batches & CSV Spreadsheet Import",
    category: "Batch GL Ingestion",
    description: "Stage multiple full journal batches concurrently via accordion cards or 1-click CSV template upload.",
    type: "JOURNAL",
    debit: {
      account: "Multi-Batch Debit Accounts",
      code: "COA-VARIOUS",
      type: "Multi-Line Debits",
      note: "Each batch maintains its own independent double-entry balancing invariant",
    },
    credit: {
      account: "Multi-Batch Credit Accounts",
      code: "COA-VARIOUS",
      type: "Multi-Line Credits",
      note: "CSV template automatically groups rows by batch narrative",
    },
    portalAction: "Open Bulk Journal Studio > Download CSV Template > Upload CSV or Add Batches > Post All to GL",
    portalLink: "/finance/journal-entries/bulk",
    exampleData: {
      amount: "KES 450,000.00 (3 Batches)",
      partner: "Enterprise GL Importer",
      division: "Multi-Division",
      ledgerBook: "General Journal",
      paymentMethod: "CSV Automated Upload",
    },
  },
  {
    title: "Customer Receipt Settlement against Invoices with eTIMS",
    category: "Receivables Inflow",
    description: "Clear customer invoice balance via executive receipts studio with GL post rate and eTIMS fiscal compliance.",
    type: "MONEY_IN",
    debit: {
      account: "Operating Bank / M-Pesa Account",
      code: "1010-BNK",
      type: "Asset (Increases with Debit)",
      note: "Liquid funds received and verified against payment gateway",
    },
    credit: {
      account: "Trade Accounts Receivable (AR)",
      code: "1030-AR",
      type: "Asset (Credit Reduces AR Balance)",
      note: "Clears customer invoice debt and updates aging matrix",
    },
    portalAction: "Open Receipts Studio > Select Customer / Partner > Choose Invoice > Issue Receipt",
    portalLink: "/finance/receipts",
    exampleData: {
      amount: "KES 185,000.00",
      partner: "Acme Holdings Kenya",
      division: "Enterprise Accounts",
      ledgerBook: "[1010] Commercial Bank",
      paymentMethod: "RTGS Bank Transfer",
    },
  },
  {
    title: "Simple Transactions Studio with Proof Attachment",
    category: "Operational Outflows",
    description: "Quick disbursement with automatic double-entry journal generation and receipt image upload.",
    type: "MONEY_OUT",
    debit: {
      account: "Expense Book (with [code] Name)",
      code: "6030-EXP",
      type: "Expense (Increases with Debit)",
      note: "Mapped to exact Chart of Accounts taxonomy with [code] prefix",
    },
    credit: {
      account: "Payment Method Account (Bank / M-Pesa / Cash)",
      code: "1020-MPESA",
      type: "Asset (Decreases with Credit)",
      note: "Receipt/invoice file attachment permanently linked to audit record",
    },
    portalAction: "Open Simple Transactions > Toggle Money Out > Attach File > Log Transaction",
    portalLink: "/finance/simple-transactions",
    exampleData: {
      amount: "KES 18,500.00",
      partner: "Office Supplies Vendor",
      division: "Head Office",
      ledgerBook: "[6030] Office Stationery & Supplies",
