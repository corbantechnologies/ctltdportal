      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          ...
          <h1 className="text-4xl font-semibold text-slate-900 tracking-tight italic">
            Operational <span className="text-blue-600">Divisions</span>
          </h1>
          <p className="text-slate-400 font-semibold mt-2 text-sm max-w-lg">
            Organize business units, define operational boundaries, and manage institutional protocols across the workspace.
          </p>
        </div>
        <CreateDivisionModal />
      </div>
