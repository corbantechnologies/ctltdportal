        ...
        <div className="lg:col-span-8 space-y-12">
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-[#2563EB] rounded flex items-center justify-center text-white shadow-2xl shadow-blue-600/20">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50 border-b border-slate-100">
                    <th className="py-6 px-8 text-[10px] font-bold uppercase tracking-widest text-black">Asset Inventory</th>
                  ...
                  {quotation.lines?.length === 0 ? (
                    <tr>
                        <td colSpan={5} className="py-20 px-8 text-center text-black/20">
                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-2">Build Required</p>
                            <p className="text-xs italic">Construct your proposal by adding catalog components.</p>
                        </td>
                    </tr>
                  ) : (
